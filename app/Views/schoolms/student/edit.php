                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row <?= $stepper ?>"
                            ...
                            <div class="flex-row-fluid">
                                <form class="form w-lg-600px mx-auto" novalidate="novalidate" action="<?= base_url('/sms/user/student/update') ?>" method="POST" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="student_id" value="<?= $row['student_id'] ?>">
                                <input type="hidden" name="old_foto" value="<?= $row['student_image'] ?>">
                                    <div class="mb-5" style="min-height: 400px">
                                        <div class="flex-column <?= $step1 ?>" data-kt-stepper-element="content">
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <style>
                                                        .image-input-placeholder {
                                                            background-image: url('<?= base_url('images/student/').$row['student_image'] ?>');
                                                        }
                                                ...
                                                <div class="col-md-6 fv-row">
                                                    <div class="mb-10">
                                                        ...
                                                        <input type="text" class="form-control form-control-md <?= $fe ?>" name="first_name" id="first_name" value="<?= old('first_name') ? old('first_name') : $row['student_first_name'] ?>" />
                                                        <?= $msg ?>
                                                    </div>
                                                    <div class="">
                                                        <?php 
                                                        ...
                                                        <input type="text" class="form-control form-control-md <?= $fe ?>" name="last_name" id="last_name" value="<?= old('last_name') ? old('last_name') : $row['student_last_name'] ?>" />
                                                        <?= $msg ?>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-md-4 fv-row">
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="birth_place" id="birth_place" value="<?= old('birth_place') ? old('birth_place') : $row['student_birth_place'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-4 fv-row">
                                                    <?php 
                                                    ...
                                                    <input type="date" class="form-control form-control-md <?= $fe ?>" name="birth_date" id="birth_date" value="<?= old('birth_date') ? old('birth_date') : $row['student_birth_date'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-4 fv-row">
                                                    <?php 
                                                    ...
                                                    <input type="number" class="form-control form-control-md <?= $fe ?>" name="order_child" id="order_child" value="<?= old('order_child') ? old('order_child') : $row['student_child_order_in_family'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                        ...
                                                        $option_religion = old('religion') ? old('religion') : $row['student_religion'];
                                                    ?>
                                        ...
                                        <div class="flex-column <?= $step2 ?>" data-kt-stepper-element="content">
                                            <div class="mb-5">
                                                ...
                                                <input inputmode="number" class="phone form-control form-control-md <?= $fe ?>" name="phone" id="phone" value="<?= old('phone') ? old('phone') : $row['student_phone'] ?>" />
                                                <?= $msg ?>
                                            </div>
                                        ...
                                        <div class="flex-column <?= $step3 ?>" data-kt-stepper-element="content">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="number" class="form-control form-control-md <?= $fe ?>" name="postal_code" id="postal_code" value="<?= old('postal_code') ? old('postal_code') : $row['student_postal_code'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="flex-column <?= $step4 ?>" data-kt-stepper-element="content">
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="father_name" id="father_name" value="<?= old('father_name') ? old('father_name') : $row['student_father_name'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="father_occupation" id="father_occupation" value="<?= old('father_occupation') ? old('father_occupation') : $row['student_father_occupation'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="mother_name" id="mother_name" value="<?= old('mother_name') ? old('mother_name') : $row['student_mother_name'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="mother_occupation" id="mother_occupation" value="<?= old('mother_occupation') ? old('mother_occupation') : $row['student_mother_occupation'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="number" class="form-control form-control-md <?= $fe ?>" name="parent_postal_code" id="parent_postal_code" value="<?= old('parent_postal_code') ? old('parent_postal_code') : $row['student_parent_postal_code'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                    ...
                                                    <input inputmode="number" class="phone form-control form-control-md <?= $fe ?>" name="parent_phone" id="parent_phone" value="<?= old('parent_phone') ? old('parent_phone') : $row['student_parent_phone'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-column <?= $step5 ?>" data-kt-stepper-element="content">
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="guardian_name" id="guardian_name" value="<?= old('guardian_name') ? old('guardian_name') : $row['student_guardian_name'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                    ...
                                                    <input type="text" class="form-control form-control-md <?= $fe ?>" name="guardian_occupation" id="guardian_occupation" value="<?= old('guardian_occupation') ? old('guardian_occupation') : $row['student_guardian_occupation'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="number" class="form-control form-control-md <?= $fe ?>" name="guardian_postal_code" id="guardian_postal_code" value="<?= old('guardian_postal_code') ? old('guardian_postal_code') : $row['student_guardian_postal_code'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                    ...
                                                    <input inputmode="number" class="phone form-control form-control-md <?= $fe ?>" name="guardian_phone" id="guardian_phone" value="<?= old('guardian_phone') ? old('guardian_phone') : $row['student_guardian_phone'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex-column <?= $step6 ?>" data-kt-stepper-element="content">
                                            <div class="row mb-5">
                                                <div class="col-md-3 fv-row">
                                                    ...
                                                    <input class="nisn form-control" name="nisn" id="nisn" value="<?= old('nisn') ? old('nisn') : $row['student_nisn'] ?>">
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-4 fv-row">
                                                    <?php 
                                                        ...
                                                        $opt_grade = old('grade') ? old('grade') : $row['grade'];
                                                    ?>
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-md-6 fv-row">
                                                    ...
                                                    <input type="date" class="form-control form-control-md <?= $fe ?>" name="registered_date" id="registered_date" value="<?= old('registered_date') ? old('registered_date') : $row['student_registered_date'] ?>" />
                                                    <?= $msg ?>
                                                </div>
                                                <div class="col-md-6 fv-row">
                                                    <?php 
                                                        ...
                                                        $radio_transfer = old('transfer') ? old('transfer') : $row['student_is_transfer'];
                                                    ?>
                                                    <label for="transfer" class="mb-5 required form-label <?= $le ?>">Terdaftar Sebagai Siswa</label>
                                                    <br>
                                                    <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                        <input class="form-check-input" type="radio" name="transfer" value="1" id="teach1" <?= $radio_transfer == 1 ? 'checked' : '' ?> />
                                                        <label class="form-check-label text-dark" for="teach1">
                                                            Baru
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                        <input class="form-check-input" type="radio" name="transfer" value="2" id="teach2" <?= $radio_transfer == 2 ? 'checked' : '' ?>/>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="text" class="form-control form-control-md <?= $fe ?>" name="previous_school" id="previous_school" value="<?= old('previous_school') ? old('previous_school') : $row['student_previous_school'] ?>" />
                                                <?= $msg ?>
                                            </div>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <textarea class="form-control" name="registered_information" id="registered_information" cols="30" rows="3"><?= old('registered_information') ? old('registered_information') : $row['student_registered_information'] ?></textarea>
                                                <?= $msg ?>
                                            </div>
            ...
            success: function (data) {
                ...
                if (selected != '' && params.title == 'regency') {
                    let params = {
                        ...
                        'fillen': 5,
                        'title': 'subdistrict',
                        'old': '<?= old('subdistrict') ? old('subdistrict') : $row['student_subdistrict'] ?>'
                    }
