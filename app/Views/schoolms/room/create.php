...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('/sms/master/room/store') ?>" method="POST">
                    <?= csrf_field(); ?>
                    <div class="mb-10">
                        <?php 
                            $fe = $le = $msg = '';
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" class="form-control form-control-sm <?= $fe ?>" name="capacity" id="capacity" value="<?= old('capacity') ?>" />
                        <?= $msg ?>
                    </div>
                    <div class="mb-10">
                        <?php 
