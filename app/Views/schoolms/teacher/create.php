                    ...
                    <div class="col-sm-12">
                        <div class="stepper stepper-pills stepper-column d-flex flex-column flex-lg-row <?= $stepper ?>"
                            ...
                            <div class="flex-row-fluid">
                                <form class="form w-lg-600px mx-auto" novalidate="novalidate" action="<?= base_url('/sms/user/teacher/store') ?>" method="POST" enctype="multipart/form-data">
                                    <?= csrf_field(); ?>
                                    <div class="mb-5" style="min-height: 400px">
                                        ...
                                        <div class="flex-column <?= $step2 ?>" data-kt-stepper-element="content">
                                            <div class="mb-5">
                                                ...
                                                ?>
                                                <label for="phone" class="form-label <?= $le ?>">No HP/WA</label>
                                        ...
                                        <div class="flex-column <?= $step4 ?>" data-kt-stepper-element="content">
                                            <div class="row mb-5">
                                                ...
                                                <input inputmode="number" class="nip form-control" name="nip" id="nip" value="<?= old('nip') ?>">
                                                <?= $msg ?>
                                            </div>
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <input inputmode="number" class="nuptk form-control" name="nuptk" id="nuptk" value="<?= old('nuptk') ?>">
                                                <?= $msg ?>
                                            </div>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                ?>
                                                <label for="employment_status" class=" required form-label <?= $le ?>">Status Kepegawaian</label>
                                                <br>
                                                <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                    <input class="form-check-input" type="radio" name="employment_status" value="1" id="emp1" <?= old("employment_status") == 1 ? 'checked' : '' ?> />
                                                    <label class="form-check-label text-dark" for="emp1">
                                                        PNS
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                    <input class="form-check-input" type="radio" name="employment_status" value="2" id="emp2" <?= old("employment_status") == 2 ? 'checked' : '' ?>/>
                                                    <label class="form-check-label text-dark" for="emp2">
                                                        Tetap
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                    <input class="form-check-input" type="radio" name="employment_status" value="3" id="emp3" <?= old("employment_status") == 3 ? 'checked' : '' ?>/>
                                            ...
                                            <div class="mb-5">
                                                ...
                                                ?>
                                                <label for="is_teaching" class="required form-label <?= $le ?>">Mengajar di kelas</label>
                                                <br>
                                                <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                    <input class="form-check-input" type="radio" name="is_teaching" value="1" id="teach1" <?= old("is_teaching") == 1 ? 'checked' : '' ?> />
                                                    <label class="form-check-label text-dark" for="teach1">
                                                        Ya
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-custom form-check-solid me-10 form-check-inline">
                                                    <input class="form-check-input" type="radio" name="is_teaching" value="2" id="teach2" <?= old("is_teaching") == 2 ? 'checked' : '' ?>/>
