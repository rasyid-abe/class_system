...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('/sms/master/exam-schedule/update') ?>" method="POST">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="exam_schedule_id" value="<?= $row['exam_schedule_id'] ?>">
                    <div class="mb-10">
                        <?php
                        $fe = $le = $msg = '';
                        ...
                        $opt = old('day') ? old('day') : $row['exam_schedule_day'];
                        ?>
                        <label for="day" class="required form-label <?= $le ?>">Hari <?= $row['exam_schedule_day'] ?></label>
                    ...
                    <div class="mb-10">
                        ...
                        $opt = old('order') ? old('order') : $row['exam_schedule_order'];
                        ?>
                    ...
                    <div class="col-md-12 fv-row">
                        <div class="row mb-5">
                            <div class="col-md-6 fv-row">
                                ...
                                $val = explode(' - ', $row['exam_schedule_time']);
                                ?>
