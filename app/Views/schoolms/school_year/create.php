...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('/sms/master/school-year/store') ?>" method="POST">
                    <?= csrf_field(); ?>
                    <div class="mb-10">
                        <?php 
                            $fe = $le = $msg = '';
                        ...
                        <input type="text" class="form-control form-control-sm <?= $fe ?>" name="year_period" id="year_period" value="<?= old('year_period') ?>" />
                        <?= $msg ?>
                    </div>
                    <div class="mb-10">
                        <?php 
                        ...
                        <input type="date" class="form-control form-control-sm <?= $fe ?>" name="start_date_one" id="start_date_one" value="<?= old('start_date_one') ?>" />
                        <?= $msg ?>
                    </div>
                    <div class="mb-10">
                        <?php 
                        ...
                        <input type="date" class="form-control form-control-sm <?= $fe ?>" name="end_date_one" id="end_date_one" value="<?= old('end_date_one') ?>" />
                        <?= $msg ?>
                    </div>
                    <div class="mb-10">
                        <?php 
                        ...
                        <input type="date" class="form-control form-control-sm <?= $fe ?>" name="start_date_two" id="start_date_two" value="<?= old('start_date_two') ?>" />
                        <?= $msg ?>
                    </div>
                    <div class="mb-10">
                        <?php 
                        ...
                        <input type="date" class="form-control form-control-sm <?= $fe ?>" name="end_date_two" id="end_date_two" value="<?= old('end_date_two') ?>" />
                        <?= $msg ?>
                    </div>
