    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-500px w-md-325px" data-kt-menu="true">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <div class="image-input image-input-outline image-input-placeholder"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url(<?= base_url() ?>blaze-assets/media/avatars/300-6.jpg);">
                                            </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-6.jpg" alt="Emma Smith"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="../dist/apps/user-management/users/view.html" class="menu-link px-3">Edit</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-1.jpg" alt="Max Smith"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-5.jpg" alt="Sean Bean"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-25.jpg" alt="Brian Cox"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-9.jpg"
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-23.jpg" alt="Dan Wilson"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-12.jpg" alt="Ana Crown"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
                ...
                <tr>
                    ...
                    <td class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                            <a href="../dist/apps/user-management/users/view.html">
                                <div class="symbol-label">
                                    <img src="<?= base_url() ?>blaze-assets/media/avatars/300-13.jpg" alt="John Miller"
                                        class="w-100" />
                                </div>
                            </a>
                        </div>
